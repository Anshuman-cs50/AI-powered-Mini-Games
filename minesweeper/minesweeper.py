...
class Sentence():
    ...
    def mark_mine(self, cell):
        ...
        if cell in self.cells:
            self.cells.discard(cell) # remove the cell from the cells
            self.count -= 1 # decrease the count of mines
    ...
    def mark_safe(self, cell):
        ...
        """
        self.cells.discard(cell) # remove the safe cell
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # 3. Determine neighbors that are not already known to be safe or mines
        neighbors = set()
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
                if (i, j) == cell:
